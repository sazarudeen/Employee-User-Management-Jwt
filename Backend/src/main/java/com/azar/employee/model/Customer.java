 ...
 * 
 * import jakarta.persistence.CollectionTable; import
 * jakarta.persistence.Column; import jakarta.persistence.ElementCollection;
 ...
 * jakarta.persistence.JoinColumn; import jakarta.persistence.Table; import
 * lombok.Data;
 * 
 * @Data
 * 
 * @Entity
 * 
 * @Table(name = "user_info") public class User {
 * 
 * @Id
 * 
 ...
 * 
 * @CollectionTable(name = "roles_info",joinColumns
 * = @JoinColumn(referencedColumnName = "id",name = "customer_id"))
 * 
 * @Column(name = "role") private Set<String> roles;
 * 
 * 
 * public User(){ this.roles = new HashSet<>(); this.roles.add("user"); }
 * 
 * }
 */